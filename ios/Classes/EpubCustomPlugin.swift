...
public class EpubCustomPlugin: NSObject, FlutterPlugin,FolioReaderPageDelegate,FlutterStreamHandler {
  ...
  //    result("iOS " + UIDevice.current.systemVersion)
      ...
      private func setPageHandler(){
          EpubCustomPlugin.pageChannel?.setStreamHandler(self)

      }
      
      public func onListen(withArguments arguments: Any?, eventSink events: @escaping FlutterEventSink) -> FlutterError? {
          EpubCustomPlugin.pageResult = events
          return nil
      }
      ...
      public func pageWillLoad(_ page: FolioReaderPage) {
          ...
          if (EpubCustomPlugin.pageResult != nil){
              EpubCustomPlugin.pageResult!(String(page.pageNumber))
          }
